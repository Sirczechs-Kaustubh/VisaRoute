...
function LoginForm() {
  ...
  const [error, setError] = useState(linkExpired ? "Reset link expired or invalid. Request a new one." : "");
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3.5 py-2.5 pr-10 rounded-lg border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition"
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            No account?{" "}
            <Link
              href={`/auth/signup${nextUrl !== "/apply" ? `?next=${encodeURIComponent(nextUrl)}` : ""}`}
